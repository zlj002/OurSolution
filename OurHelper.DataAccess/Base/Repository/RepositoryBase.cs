...
using OurHelper.Entity.Extend;
using OurHelper.DataAccess.Helper;

namespace OurHelper.DataAccess.Base.Repository
{
    /// <summary>
    ...
    public abstract class RepositoryBase<T> : IRepository<T> where T : class,new()
    {
        ...
        /// 默认构造
        /// </summary>
        public RepositoryBase(DbContextFactory dbFactory)
        {
            this.context = dbFactory.GetDbContext();
        }
        ...
        /// <param name="parameters"></param>
        /// <returns></returns>
        protected int GetCount(string sqlString, params object[] parameters)
        {
            try
            {
