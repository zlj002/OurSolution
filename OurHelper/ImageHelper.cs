...
namespace OurHelper
{
    ...
    public class ImageHelper
    {
        ...
        {
            if (contentType.ToLower() == "image/pjpeg" || contentType.ToLower() == "image/jpeg" || contentType.ToLower() == "image/gif" || contentType.ToLower() == "image/bmp" || contentType.ToLower() == "image/png")
            {
                return true;
            }
            else
